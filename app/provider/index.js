...
import ProviderCallsController from './controllers/ProviderCallsController';
import ProviderAuthorizationsController from './controllers/ProviderAuthorizationsController';
import ProviderClaimsController from './controllers/ProviderClaimsController';
...
providerModule.controller('ProviderCallsController', ProviderCallsController);
providerModule.controller('ProviderAuthorizationsController', ProviderAuthorizationsController);
providerModule.controller('ProviderClaimsController', ProviderClaimsController);
