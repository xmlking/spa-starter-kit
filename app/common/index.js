...
import ScrollOnClickDirective from './elements/ScrollOnClickDirective';
import ContenteditableDirective from './elements/ContenteditableDirective';
...
commonModule.directive('scrollOnClick', ($rootScope, $timeout, $location) => new ScrollOnClickDirective($rootScope, $timeout, $location));
commonModule.directive('contenteditable', ($sce) => new ContenteditableDirective($sce));
...
commonModule.filter('string_replace', [() => Formaters.replace]);
commonModule.filter('string_camelcase', [() => Formaters.camelcase]);
